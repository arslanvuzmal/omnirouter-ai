      ...
      <div className="mx-auto max-w-4xl px-5 py-16">
        <header>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-ink-400">
            The demonstration runs entirely on a deterministic in-process provider. No
            external API key is required, and no request leaves this deployment.
          </p>
        </header>

        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          <Panel className="flex flex-col p-6">
            <h2 className="text-sm font-semibold text-ink-50">Guided walkthrough</h2>
            <p className="mt-2 flex-1 text-xs leading-relaxed text-ink-400">
              Six steps, about a minute. Watch a request route, a provider fail, and the
              fallback recover — reading real seeded requests rather than screenshots.
            </p>
            <Link
              href="/demo/story"
          ...
          <Panel className="flex flex-col p-6">
            <h2 className="text-sm font-semibold text-ink-50">Full dashboard access</h2>
            <p className="mt-2 flex-1 text-xs leading-relaxed text-ink-400">
              Sign in as any of four roles and use the product directly — playground,
              routing policies, request traces and analytics.
            </p>
            <Link
              href="/login"
        ...
        <section className="mt-10">
          ...
          <p className="mt-2 text-sm leading-relaxed text-ink-400">
            Each role sees a different subset of the product. Signing in as the viewer and
            trying to run a request is the quickest way to see that permissions are
          ...
          <p className="mt-4 text-[11px] leading-relaxed text-ink-600">
            The demo workspace is protected: destructive operations are disabled because
            the data is shared between visitors. It contains no real provider credentials
            and cannot reach a production system.
          </p>
        </section>
      </div>
    </MarketingShell>
